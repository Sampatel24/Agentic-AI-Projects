...
In Project 1, you built a chatbot — it reads text and responds. Now you build an **agent** — it decides what actions to take, runs them, reads the results, and keeps going until it has an answer.
...
One file: [`docker_agent.py`](docker_agent.py)
...
```bash
python3 Project_2-Docker_Troubleshooter_Agent/docker_agent.py
```
