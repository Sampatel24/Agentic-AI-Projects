"""
Checks if your machine has all the depended tools and libraries.
Run: python3 Project_Pre-Requisite/verify_setup.py
"""
...
print(f"\n{'—' * 40}")
if passed == total:
    print(f"  {passed}/{total} — you're ready to build the Agentic AI Projects!")
else:
